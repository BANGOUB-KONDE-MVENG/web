 ...
 * @author jacques
 */
public class Recherchedateformationservlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String ladate= request.getParameter("datedebut");
        Date start = new Date();
        SimpleDateFormat ft = new SimpleDateFormat ("yyyy-MM-dd");
        try { 
          start = ft.parse(ladate);
        ...
        "/jsp/resultatrecherchedate.jsp").forward( request, response );
