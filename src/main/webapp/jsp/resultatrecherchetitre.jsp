      ...
      -->
        ...
        <div class="container-formation">
                <div class="title-container">
                    Résulat recherche Cours pour "<font style="color:green;font-style:italic;">${wordsearch}</font>"
                </div>
              <c:choose>
                <c:when test="${lstCourse == null}">
                    <p>Oops ! aucun cours trouvé</p>
                </c:when>
                <c:otherwise>
                    <c:forEach var="lstfor" items="${lstCourse}">  
                        <div class="items-formations course">
                            <div class="book"></div>
                            <div class="title">
                                ${lstfor.title}
                            </div>
