...
<html>
    <head>
        <title>Recherche par lieu </title>
      ...
      -->
        ...
        <div class="container-formation">
                <div class="title-container">
                    Résultat recherche lieu formation pour "<font style="color:green;font-style:italic;">${wordsearch}</font>"
                </div>
              <c:choose>
                <c:when test="${lstSession == null}">
                    <p>Aucune formations disponisble pour ce lieu</p>
                </c:when>
                <c:otherwise>
                    <c:forEach var="lstfor" items="${lstSession}">  
