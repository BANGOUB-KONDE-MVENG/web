<%-- 
    Document   : Connexion
    Created on : 26 mai 2016, 12:44:29
    Author     : jacques
--%>
    ...
    <body>
      ...
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.jsp">Fomation en Ligne</a>
        </div>
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="http://getbootstrap.com/examples/starter-template/#about">A propos</a></li>
